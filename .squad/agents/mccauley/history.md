...
- 2026-05-09: M1 scope contract is provisional because the repo has no canonical milestone source-of-truth; acceptance must be artifact-backed and tied to the owned structure, not prose-only status.
- 2026-05-09: M1 now has a resolved evidence home in `tests/README.md`, and `docs/project-structure.md` stays the canonical map. The scope contract remains provisional, but the acceptance trail is no longer ambiguous.
